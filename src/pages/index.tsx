  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System - Empowering Employers to Efficiently Manage Employee Data, Vacations, and Payroll in One Centralized Hub"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System - Empowering Employers to Efficiently Manage Employee Data, Vacations, and Payroll in One Centralized Hub`}
            </Text>
            <Box
